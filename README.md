...
- copy or merge the template's [package~.json](templates/primevue/package~.json) as your new ./package.json (or selectively copy/paste, especially the following scripts, and codegen configuration)
...
- optionally generate GraphQL schema files: `yarn gen-gql` (alternatively, ditto the above)

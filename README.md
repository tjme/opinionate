...
- you are advised to initialize version control to help track source code changes (e.g. `git init`)
- copy or merge the template's [package~.json](templates/primevue/package~.json) as your new ./package.json (or copy/paste the full versions of the following shorthand scripts)
